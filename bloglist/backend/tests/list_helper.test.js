...
describe('favoriteBlog', () => {
  ...
  test('when list has one blog return this blog', () => {
    const result = listHelper.favoriteBlog(oneBlog)
    assert.deepStrictEqual(result, { title: "React patterns", author: "Michael Chan", likes: 7})
  })

  test('when list has many blogs return one with highest likes', () => {
  ...
  test('when list has no blogs return an appropriate message', () => {
